...
<html>
    ...
    <iframe name=hole2 width=0 height=0 style="visibility:hidden"></iframe>
		<table border='2'>
			...
			<h2><font color='#FFFFFF'> CAMERA AND STATS </font></h2>
				</td>
			</tr>
			<tr>
				<td>
					<iframe src="http://192.168.86.71:3000/dashboard-solo/db/monitoring-environment?orgId=1&panelId=2" width="225" height="200" frameborder="0"></iframe>
				</td>
				<td>
					<iframe src="http://192.168.86.71:3000/dashboard-solo/db/monitoring-environment?orgId=1&panelId=3" width="225" height="200" frameborder="0"></iframe>	
				</td>
			</tr>
			<tr>
				<td colspan='2'>
			...
			<tr>
				...
				<td>
					<iframe src="http://192.168.86.71:3000/dashboard-solo/db/monitoring-environment?orgId=1&panelId=4" width="225" height="200" frameborder="0"></iframe>
                        ...
                        <tr>
                            <form id='lightform' target='hole' action='http://192.168.86.71/cgi-bin/pixels.cgi' method='post'><td colspan=2 align=center><font color='#FFFFFF'>night light</font></td></tr>
                            ...
                            <td colspan=2 align='center'><input type='submit'></td></tr></form>
                        <tr>
                            <form id='musicform' target='hole2' action='http://192.168.86.71/cgi-bin/music.cgi' method='post'><td colspan=2 align=center><font color='#FFFFFF'>music</font></td></tr>
